...
public class SpingPersionController extends ActionSupport implements SpringPersionInterface
{
   ...
   */
   ...
   返回:
   {
    ...
    public Persion getMaxPersion()
    {
        Persion persion = new Persion();
        persion.setName("DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意" +
                "DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意" +
                "DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意" +
                "DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意" +
                "DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意" +
                "DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意" +
                "DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意" +
                "DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意" +
                "DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意" +
                "DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意" +
                ...
                "DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意" +
                "DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意" +
                "DSP8是芬朗自主设计的第一款品牌音频处理器，其输入方式更有蓝牙音频无缝连接，光纤信号输入，分频方式可为主动3分频/前主动2分频、后被动分频/全被动分频随意设置；在输出调节上，输出8通道独立时间延迟、独立31段EQ，独立Q值，独立电平和相位调节，高.低.带通、斜率和分频点都可随意");
